...
from app.routes.wix_images import router as wix_images_router

# Routers - Marketing Automation
...
print("### LOADING Luxura Inventory API v3.0 ###")
...
app.include_router(wix_images_router)
